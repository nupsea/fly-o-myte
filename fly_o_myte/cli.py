...
def setup() -> None:
    ...
    console.print("This wizard creates [dim]~/.fly-o-myte/config.yaml[/dim] with your family profile.\n")
...
def scout(
    ...
    from fly_o_myte.scout import scout_month, scout_flex
...
def watch(
    ...
    from fly_o_myte.db.sqlite import Trip, get_session, insert_trip, list_all_trips
...
def status(
    ...
    from fly_o_myte.db.sqlite import get_session, list_all_trips, list_active_trips, get_latest_recommendation
...
def compare(
    ...
    from fly_o_myte.db.sqlite import get_session, get_trip, get_latest_recommendation, get_latest_snapshot
...
def history(
    ...
    from fly_o_myte.db.sqlite import get_session, get_trip, get_snapshots_for_trip
...
def remove(
    ...
    from fly_o_myte.db.sqlite import get_session, get_trip, get_snapshots_for_trip, delete_trip
